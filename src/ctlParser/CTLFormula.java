...
/**
 * an element of a BST to represent CTL
...
public class CTLFormula {
	 ...
	 * @return String
	 */
	public String getOp_var() {
		return op_var;
	}

	/**
	 * When setting the operator for the object we indicate if it is a operator
	 * or preposition.
	 * 
	 * @param op_var
	 */
	public void setOp_var(String op_var) {
		...
		if (op_var == null) {
			is_op = false;
		} else if (op_var.equals("AU") || op_var.equals("EU")
				|| op_var.equals("EX") || op_var.equals("EF")
				|| op_var.equals("EG") || op_var.equals("AX")
				|| op_var.equals("AF") || op_var.equals("AG")
				|| op_var.equals("and") || op_var.equals("not")
				|| op_var.equals("or") || op_var.equals("implies")) {
			is_op = true;
		} else {
			is_op = false;
		}
	...
	public boolean isCTLOp() {
		if (op_var.equals("AU") || op_var.equals("EU") || op_var.equals("EX")
				|| op_var.equals("EF") || op_var.equals("EG")
				|| op_var.equals("AX") || op_var.equals("AF")
				|| op_var.equals("AG") || op_var.equals("not")) {
			return true;
		} else {
			return false;
		}
	...
	private String toStringIn() {
		if (op_var.equals("and") || op_var.equals("or")
				|| op_var.equals("implies") || op_var.equals("not")
				|| op_var.equals("EX") || op_var.equals("EF")
				|| op_var.equals("EG") || op_var.equals("AX")
				|| op_var.equals("AF") || op_var.equals("AG")) {
			return " " + op_var + " ";
	...
	private String toStringPre() {
		...
		op_var.equals("and") || op_var.equals("or") || op_var.equals("implies")) {
			return "( ";
	...
	/**
	 * @param R
	 *            Right String to be added to the formula.
	 */
	...
	/**
	 * @param L
	 *            Left String to be added to the formula.
	 */
	...
	/**
	 * @param rF
	 *            Right hand CTLFormula.
	 */
	public void addRightFormula(CTLFormula rF) {
		this.right = rF;
	}

	/**
	 * @param lF
	 *            Left hand CTLFormula.
	 */
	public void addLeftFormula(CTLFormula lF) {
		this.left = lF;
	}
	...
	public void setLeft(CTLFormula left) {
		this.left = left;
	}

	public void setRight(CTLFormula right) {
		this.right = right;
	}
